...
<head>
    ...
    <script src="assets/js/dark_mode.js" defer></script> <!-- Ajout de 'defer' pour s'assurer que le script est chargé après le HTML -->
</head>
<body>
    ...
    <header>
        ...
        <div> <button id="toggleBtn"> dark </button></div>
    </header>
    <hr>
    <main>
        <div class="slogan">
